...
use App\Http\Requests\Structures\Category\StoreRequest;
use App\Http\Requests\Structures\Category\UpdateRequest;
use App\Http\Resources\Structures\AgencyCategoryResource;
...
class AgencyCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $categories = $fetchAll ? $categories->get()->toJson() : AgencyCategoryResource::collection($categories->paginate($perPage)->onEachSide(1));
        return $categories;
    }
     ...
     *
     * @param  App\Http\Requests\Structures\Category\StoreRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Models\Structures\Category  $category
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Http\Requests\Structures\Category\UpdateRequest  $request
     * @param  \App\Models\Structures\Category  $category
     * @return \Illuminate\Http\Response
     */
