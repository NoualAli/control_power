@php
    ...
    $appCss = public_path('/special_styles/mission.css');
    $qlCss = public_path('/special_styles/ql.css');
    $appBrand = public_path('app\images\brand.png');
    $bnaLogo = public_path('app\images\bna_logo.png');
