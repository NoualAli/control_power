      ...
      <form @submit.prevent="updateProfile" @keydown="infoForm.onKeydown($event)">
        ...
        <div class="grid gap-3 my-4">
          ...
          <div class="col-12 col-lg-4 col-md-6">
            <NLInput v-model="infoForm.first_name" :form="infoForm" name="firstname" label="firstname" />
          </div>

          <!-- Lastname -->
          <div class="col-12 col-lg-4 col-md-6">
            <NLInput v-model="infoForm.last_name" :form="infoForm" name="last_name" label="lastname" />
          </div>

          <!-- Username -->
          <div class="col-12 col-lg-4 col-md-6">
            <NLInput v-model="infoForm.username" :form="infoForm" name="username" label="username" label-required />
          </div>

          <!-- Phone -->
          <div class="col-12 col-lg-6 col-md-6">
            <NLInput v-model="infoForm.phone" :form="infoForm" name="phone" label="phone" type="phone" />
          </div>

          <!-- Email -->
          <div class="col-12 col-lg-6 col-md-6">
            <NLInput v-model="infoForm.email" :form="infoForm" name="email" label="email" label-required type="email" />
          </div>
        </div>
        <!-- Submit Button -->
      ...
      <form @submit.prevent="updatePassword" @keydown="passwordForm.onKeydown($event)">
        ...
        <div class="grid gap-3 my-4">
          ...
          <div class="col-12 col-lg-4">
            <NLInput
              v-model="passwordForm.current_password" :form="passwordForm" label="current_password"
