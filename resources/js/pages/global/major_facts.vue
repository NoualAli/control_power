<template>
    <ContentBody>
        ...
        <NLModal v-if="modals.edit" :show="modals.edit" @close="close('edit')">
            <template #title>
                <small>
            ...
            <template #default>
                ...
                <form enctype="multipart/form-data" class="grid gap-6" @submit.prevent="save('edit')"
                    ...
                    <!-- Score -->
                    <div class="col-12">
                        <NLInput v-model="rowSelected.appreciation" label="Notation" readonly labelRequired />
                    </div>

                    <!-- Metadata -->
                    <div v-if="rowSelected?.control_point?.fields && !forms.detail.process_mode" class="col-12">
                        <div class="repeater">
                            <h2 class="mb-6">
                    ...
                    <div v-else-if="rowSelected?.control_point?.fields && forms.detail.process_mode" class="col-12"
                        ...
                        <table v-if="rowSelected?.parsed_metadata">
                            <thead>
                                <tr>
                                    <th v-for="(heading, index) in Object.keys(rowSelected?.parsed_metadata)" :key="index"
                                        class="text-left">
                                        {{ heading }}
                                    </th>
                                </tr>
                    ...
                    <!-- Report -->
                    <div class="col-12">
                        <NLTextarea v-model="forms.detail.report" label="Constat" placeholder="Ajouter votre constat"
                            labelRequired readonly />
                    </div>
                    <!-- Media (attachements) -->
                    <div class="col-12">
                        <NLFile v-model="forms.detail.media" :name="'media'" label="Pièces jointes"
                            ...
                            :form="forms.detail" multiple :readonly="!forms.detail.process_mode" />
                    </div>
                    <!-- Recovery plan -->
                    <div class="col-12">
