<template>
    <ContentBody v-if="can('view_agency')">
        <NLDatatable :columns="columns" :filters="filters" :actions="actions" urlPrefix="structures/agencies"
            @edit="edit" @delete="destroy" @dataLoaded="handleDataLoaded" :refresh="refresh">
        ...
        destroy(item) {
            this.$swal.confirm_destroy().then((action) => {
                if (action.isConfirmed) {
                    api.delete('structures/agencies/' + item.id).then(response => {
