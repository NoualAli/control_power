<template>
    ...
    <NLSidebarItem label="Etat des missions" route="missions-states" iconName="news" />
...
<script>
import NLSidebarItem from '../../components/Sidebar/NLSidebarItem.vue'
export default {
    name: "InspectionSidebar",
    components: { NLSidebarItem }
}
</script>
