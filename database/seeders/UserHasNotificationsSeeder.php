...
class UserHasNotificationsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::transaction(function () {
            ...
            //     ->join('roles', 'users.active_role_id', 'roles.id')->whereIn('code', ['cder', 'cdrcp', 'dg', 'dga', 'sg', 'ig', 'deac', 'der'])->get();
            ...
            //         $currentUser = $user;
            //         if (in_array($user->code, ['cdrcp', 'dg', 'dga', 'sg', 'ig', 'deac', 'der'])) {
            ...
            //                 $currentType = $type;
            //                 if (in_array($user->code, ['dg', 'ig', 'dga', 'sg', 'der', 'deac', 'cdrcp'])) {
